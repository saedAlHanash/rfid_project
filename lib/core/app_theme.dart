...
final appTheme = ThemeData(
  ...
  floatingActionButtonTheme: FloatingActionButtonThemeData(
    ...
    iconSize: 30.0.r,
    smallSizeConstraints: BoxConstraints(maxWidth: 30.0.r, maxHeight: 30.0.r),
  ...
  elevatedButtonTheme: ElevatedButtonThemeData(
    style: ButtonStyle(
      ...
      overlayColor: WidgetStateProperty.resolveWith<Color?>((Set<WidgetState> states) => secondaryColor),
    ),
  ),
  ...
  listTileTheme: ListTileThemeData(minTileHeight: 0),
  iconButtonTheme: IconButtonThemeData(
    style: ButtonStyle(padding: WidgetStatePropertyAll(const EdgeInsets.all(2.0).r)),
  ),
  checkboxTheme: const CheckboxThemeData(fillColor: WidgetStatePropertyAll(AppColorManager.mainColor)),
